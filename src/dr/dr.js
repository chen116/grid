...
const camera = new BABYLON.ArcRotateCamera("camera", -Math.PI / 2, Math.PI /2, 15, new BABYLON.Vector3(0, 0, -50));
...
planeGrid([0,0,0],[0,0,1],500,500,gridmaterial,scene);
...

{
  ...
  var mesh = BABYLON.Mesh.CreateLines("slines", path, scene, true);
...
//   var y = i;
//   var z = 0;
//   mousePath[0].push(new BABYLON.Vector3(x, y, z));
// }
// var mouseMesh = BABYLON.Mesh.CreateLines("lines", mousePath, scene, true);
// var mouseMesh = BABYLON.MeshBuilder.CreateLineSystem("lineSystem", {lines: mousePath, updatable: true}, scene);
    ...
    scene.registerBeforeRender(function() {
      ...
      //updateLines(mesh, path);
       // mouseMesh = BABYLON.Mesh.CreateLines(null, mousePath, null, null, mouseMesh);
...
// BABYLON.MeshBuilder.CreateLineSystem("lineSystem", {lines: mousePath, instance: mouseMesh});
  ...
  // scene.onPointerMove = function(ev, pk){
  //   // console.log("x",scene.pointerX);
  //   // console.log("y",scene.pointerY);
  //   // console.log("z",pk.pickedPoint.z);
  //   // document.getElementById("x").innerHTML="x:"+scene.pointerX;
  //   document.getElementById("y").innerHTML="y:"+scene.pointerX;
  //   // document.getElementById("z").innerHTML="z:"+scene.pointerZ;
  //
  // }
